...
(function() {
    ...
    var y, B = document,
        ...
        Qb = "stroke-width",
        Aa, gb, ob, eb, sb, tb, ub, Xa, Ya, Za, Eb, Fb, Gb, Hb, vb, wb, xb, M = {},
        A;
    ...
    A.numberFormat = function(a, b,
        ...
        var e = T.lang,
            a = +a || 0,
            f = b === -1 ? C((a.toString().split(".")[1] || "").length, 20) : isNaN(b = O(b)) ? 2 : b,
    ...
    Q.prototype = {
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i <
                    d.length && !h; i++)
                    if (e = d[i], f = J(e, "zIndex"), e !== g && (D(f) > a || !q(a) && q(f))) c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
        ...
        buildText: function(a) {
            ...
            !f && !n && !v && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g,
                ...
                o(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var n = {},
                            s = B.createElementNS(Ca, "tspan"),
                            p;
                        h.test(e) && (p = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), J(s, "style", p));
                        i.test(e) && !d && (J(s, "onclick", 'location.href="' + e.match(i)[1] + '"'), L(s, {
                            cursor: "pointer"
                        }));
                        e = t(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || n.length > 1 && k.whiteSpace !== "nowrap", S, w, q, u = [], y = N(s), r = 1, x = a.rotation, z = e, C = z.length;
                                    (o || v) && (n.length || u.length);) a.rotation = 0, S = a.getBBox(!0), q = S.width, !ca && c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)), S = q > l, w === void 0 && (w = S), v && w ? (C /= 2, z === "" || !S && C < 0.5 ? n = [] : (S && (w = !0), z = e.substring(0, z.length +
    ...
    x(Q.prototype, {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = ya ? "-ms-transform" : ib ? "-webkit-transform" : La ? "MozTransform" : Jb ? "-o-transform" : "";
            ...
            setSpanRotation: function() {
                ...
                L(this.element, {
                    filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b,
                        ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"
                    ].join("") : P
                })
            },
                ...
                return x(e, {
                    ...
                    getCSS: function(a) {
                        var b = a.element,
                            ...
                            f = d + this.height,
                            d = {
                                clip: "rect(" + r(a ? e : d) + "px," + r(a ? f : b) + "px," + r(a ? b : f) + "px," + r(a ? d : e) + "px)"
                            };
                        !a && hb && c === "DIV" && x(d, {
                            width: b + "px",
                            height: f + "px"
    ...
    Ta.prototype = {
        addLabel: function() {
            ...
            q(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(z(g.style)).add(a.labelGroup) :
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                e = b.chart.spacing,
                f = p(b.labelLeft, C(b.pos, e[3])),
                e = p(b.labelRight, u(b.pos + b.len, d - e[1])),
                g = this.label,
                h = this.rotation,
                i = {
                    left: 0,
                ...
                l = 1,
                m, n = {};
            if (h) h < 0 && c - i * j < f ? m = r(c / X(h * ha) - f) : h > 0 && c + i * j > e && (m = r((d - c) / X(h * ha)));
            else if (d = c +
        ...
        render: function(a,
            ...
            var d = this.axis,
                ...
                q = !0,
                u = d.tickmarkOffset,
                r = this.getPosition(g, j, u, b),
                x = r.x,
                r = r.y,
                z = g && x === d.pos + d.len || !g && r === d.pos ? -1 : 1,
                c = p(c, 1);
            this.isActive = !0;
            if (v) {
            ...
            if (i && !isNaN(x)) i.xy = r = this.getLabelPosition(x, r, i, g, k, u, a, ga), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast &&
                !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r), ga && a % ga && (q = !1), q && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Qa(this, this.axis)
        }
        ...
        render: function() {
            ...
            if (m)
                if (n) m.animate({
                    ...
                    m = w.path(n).attr(t).add(), o))
                for (v in d = function(b) {
                        m.on(b, function(c) {
                            o[b].apply(a, [c])
                        })
                    }, o) d(v);
    ...
    va.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: z(ba.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === y;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = A.numberFormat(b / c, -1) + e[f]);
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        if (q(d))
                            if (a.dataMin >=
                                d) a.dataMin = d, a.ignoreMinPadding = !0;
        ...
        renderUnsquish: function() {
            ...
            if (this.autoRotation) o(c, function(a) {
                ...
                m > j && m > g.h ? k.rotation = this.labelRotation : this.labelRotation = 0;
            else if (i && (l = {
                    width: j + "px"
                }, !h)) {
                l.textOverflow = "clip";
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                for (w in f) f[w].destroy(), delete f[w];
        ...
        render: function() {
            ...
            if (v) s = a.getLinePath(v), a.axisLine ? a.axisLine.animate({
                    d: s
        ...
        drawCrosshair: function(a, b) {
            ...
            else if (p(d.snap, !0) ? q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null,
    ...
    va.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (d = c[g], e = E[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + E[c[g + 1][0]]) /
                2) break;
    ...
    va.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = r(a), g = this.getLinearTickPositions(a, b, c);
        else if (a >= 0.08)
    ...
    Nb.prototype = {
        ...
        move: function(a, b, c, d) {
            var e = this,
                ...
                !1 && !e.isHidden && (O(a - f.x) > 1 || O(b - f.y) > 1),
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                v = function() {
                    l.apply(0, i) !== !1 ? m.apply(0, j) ===
                        !1 && !h && (n(!0), v()) : h ? f.x = f.y = 0 : (n(!0), v())
                };
    ...
    nb.prototype = {
        init: function(a,
            ...
            var c = this,
                ...
                e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 20), c.pages = [], c.render(), H(c.chart, "endResize", function() {
            ...
            if (a > f) {
                ...
                o(q, function(a, b) {
                    var c = a._legendItemPos[1],
                        d = r(a.legendItem.getBBox().height),
                        e = n.length;
                ...
                if (!m) this.nav = m = d.g().attr({
                    zIndex: 1
                }).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click",
                    function() {
                        b.scroll(-1, k)
                ...
                b.scroll(0);
                a = f
            } else if (m) N(c.chartHeight), m.hide(), this.scrollGroup.attr({
                translateY: 1
            }), this.clipHeight = 0;
            return a
        },
    ...
    Na = A.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            var e = this.chart.renderer,
                f = this.legendGroup,
                a = a.baseline - r(a.fontMetrics.b * 0.3),
                g;
            if (b.lineWidth) {
                g = {
    ...
    F.prototype = {
        ...
        setChartSize: function(a) {
            ...
            this.clipBox = {
                x: b,
                y: c,
                width: V(this.plotSizeX - u(d, h[1]) / 2 - b),
                height: u(0, V(this.plotSizeY - u(d, h[2]) /
                    2 - c))
            };
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(t) : this.plotBackground = b.rect(p, o, q, u, 0).attr({
                fill: k
    ...
    R.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ra(k)) {
                        ...
                        if (q)
                            for (c = 0; c < h; c++) i = a[c], v[c] = i[0], s[c] = i.slice(1, q + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], v[c] = i[0], s[c] = i[1];
                    else la(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== y && (i = {
        ...
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (j = c[l], k = a[l], i = k !== null && k !== y && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped ||
                    (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)
                    if (i = k.length)
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                m = this.pointAttr[""],
                n, v, o, r = this.markerGroup,
                q = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {}, v = !!g.marker, a = q && n.enabled === y ||
                        n.enabled, o = g.isInside, a && e !== y && !isNaN(e) && g.y !== null)
        ...
        applyZones: function() {
            var a = this,
                ...
                h, i = this.graph,
                j = this.area,
                k = u(b.chartWidth, b.chartHeight),
            ...
            function e() {
                ...
                if (da(a) && !Ha(a)) f.redraw = function() {
                    if (h)
                        ...
                        else h.attr(f.pointAttr[f.state || ""])[f.visible === !1 ? "hide" : "show"]();
        ...
        drawGraph: function() {
            ...
            o(d, function(d) {
                ...
                g ? g.animate({
                    ...
                    fill: p(d[2], oa(d[1]).setOpacity(p(c.fillOpacity, 1)).get()),
                    zIndex: 0
                }).add(a.group)
            })
        },
    ...
    xa = ka(R, {
        ...
        getColumnMetrics: function() {
            ...
            var c = C(O(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                j = c * b.groupPadding,
                k = (c - 2 * j) / i,
                l = b.pointWidth,
        ...
        drawPoints: function() {
            ...
            o(a.points, function(h) {
                ...
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (db(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](z(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart,
            ...
            l = this.visible && (a.series.forceDL || f.isInsidePlot(h,
        ...
        if (l) d = x({
            ...
            align: c.align
        })) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape &&
            b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
    ...
    if (M.pie) M.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (m > 0) {
                        ...
                        for (G = 0; G < K; G++) {
                            ...
                            if (J < G && I[G] !== null) J = G;
                                ...
                                for (t < K - G + J && I[G] !== null && (J = t - K + G); I[J] ===
                                    null;) J++;
                            M.push({
                                i: J,
                                y: I[J]
            ...
            if (Fa(E) === 0 || this.verifyDataLabelOverflow(E)) this.placeDataLabels(), x && g && o(this.points, function(b) {
                j = b.connector;
                w = b.labelPos;
                if ((y = b.dataLabel) && y._pos && b.visible) D = y._attr.visibility, B = y.connX, A = y.connY, k = l ? ["M", B + (w[6] === "left" ? 5 : -5), A, "C", B, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", B + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]], j ? (j.animate({
                        d: k
                    }), j.attr("visibility", D)) : b.connector =
    ...
    U = A.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            if (e && !c)
                for (m = e + 1; m--;) d[m] === "M" && d.splice(m + 1, 0, d[m + 1] - i, d[m + 2], "L"), (m && d[m] ===
        ...
        pan: function(a, b) {
            ...
            o(b === "xy" ? [1, 0] : [1], function(b) {
                var d = a[b ? "chartX" : "chartY"],
                    ...
                    k = h.getExtremes(),
                    l = h.toValue(i - d, !0) + j,
                    j = h.toValue(i + c[b ? "plotWidth" : "plotHeight"] -
                        d, !0) - j,
                    i = i > d;
                if (h.series.length && (i || l > C(k.dataMin, k.min)) && (!i || j < u(k.dataMax, k.max))) h.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }), e = !0;
